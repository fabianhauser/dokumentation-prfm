...
\begin{align*}
  ...
  %HERE COMES ANOTHER RULE
	...
	& \land goal
	& \text{If we want to prove } P \land Q \text{ , we can prove } P \text{ and } Q \text{ separately.} \\ %TODO \land hyp
...
\begin{align*}
	\top & \equalhat \neg \bot \\
	P \land Q & \equalhat \neg(\neg P \lor \neg Q) %WRong
	%TODO Slide 10 from week 2, 01-02
\end{align*}


\subsubsection{Proof by case distinction}

You can prove each (sub)case, to prove the statement. %TODO: Slide 12
