...
%		\[ \frac{H \vdash Q}{\text{H},P \vdash Q} mon \] &
%			We can leave out individual Hypotheses \\
%		\[ \frac{H \vdash P \mathSpaceSeparator \text{H}, P \vdash Q \text{H} \vdash Q cut \] &
%			Allows you to introduce lemmas to simplify proving  $H \vdash Q$ \\
%		\[ \frac{}{H, \bot \vdash P} \bot hyp \] &
%			With an inconsistent system, you are able to prove anything. \\
%		\[ \frac{H, \neg P \vdash \bot}{H \vdash P} contr \] &
...
%		\[ \frac{H \vdash P}{H, \neg P \vdash Q} \neg hyp \] &
%			negations can ''jump'' over turnstile \\
%		\[ \frac{H \vdash P \mathSpaceSeparator H \vdash Q}{H \vdash P \land Q} \land goal \] &
%			If we want to prove $P \land Q$ , we can prove $P$ and $Q$ separately. \\
%		\[ \frac{H,P,Q \vdash R}{H,P \land Q \vdash R} \land hyp \] &
...
%	Conjunction & A, B & A $\land$ B \\
%	Disjunction & A;B A $\lor$ B
%\end{tabu}
...
%Todo: sLIDE 32 (lowercase or 'Asdf')

\paragraph{Variables}

%TODO: X, Y, Variable, \_tag
